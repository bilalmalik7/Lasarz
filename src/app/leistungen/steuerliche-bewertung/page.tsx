...
export default function SteuerlicheBewertungPage() {
    return (
        <main style={{ paddingTop: '100px', backgroundColor: 'var(--bg-primary)', minHeight: '100vh' }}>
            <section style={{ backgroundColor: 'var(--bg-secondary)', padding: '60px 0', borderBottom: '1px solid var(--border-color)' }}>
                <div className="container">
                    ...
                    <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: 'var(--accent-secondary)', lineHeight: 1.2, marginTop: '1rem' }}>💰 Steuerliche Immobilienbewertung</h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginTop: '1rem', maxWidth: '700px' }}>Bewertung von Immobilien für steuerliche Zwecke – anerkannt vom Finanzamt Osnabrück und deutschlandweit.</p>
                </div>
            </section>
            ...
            <section className="section">
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '3rem', alignItems: 'start' }}>
                        <div>
                            <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Immobilienbewertung für das Finanzamt</h2>
                            ...
                            <div style={{ backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px', borderLeft: '4px solid var(--accent-primary)', marginBottom: '2rem' }}>
                                <h4 style={{ marginBottom: '0.75rem', color: 'var(--accent-secondary)' }}>Steuerliche Anlässe</h4>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                    {['Erbschaft & Nachlass', 'Schenkungen', 'Bedarfsbewertung nach BewG', 'Grunderwerbsteuer', 'Einkommensteuer (Vermietung)', 'Grundsteuer & AfA-Optimierung'].map((item, i) => (
                        ...
                        <div style={{ backgroundColor: 'var(--bg-secondary)', borderRadius: '16px', padding: '2.5rem', borderLeft: '4px solid var(--accent-primary)' }}>
                            <h3 style={{ fontSize: '1.4rem', marginBottom: '1.5rem' }}>Steuerberatung anfragen</h3>
                            <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', lineHeight: 1.7 }}>Kostenlose Erstberatung zur steuerlichen Bewertung Ihrer Immobilie.</p>
            ...
            <section style={{ padding: '60px 0', backgroundColor: 'var(--accent-secondary)', color: '#fff', textAlign: 'center' }}>
                <div className="container">
                    <h2 style={{ color: '#fff', fontSize: '2rem', marginBottom: '1rem' }}>Steuern sparen mit dem richtigen Gutachten?</h2>
                    <p style={{ opacity: 0.85, marginBottom: '2rem', fontSize: '1.1rem' }}>Wir beraten Sie kompetent und zertifiziert.</p>
