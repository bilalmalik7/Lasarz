        ...
        <main style={{ paddingTop: '100px', backgroundColor: 'var(--bg-primary)', minHeight: '100vh' }}>
            <section style={{ backgroundColor: 'var(--bg-secondary)', padding: '60px 0', borderBottom: '1px solid var(--border-color)' }}>
                <div className="container">
                    ...
                    <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: 'var(--accent-secondary)', lineHeight: 1.2, marginTop: '1rem' }}>🏭 Bewertung von Gewerbe- und Industrieimmobilien</h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginTop: '1rem', maxWidth: '700px' }}>Zertifizierte Verkehrswertgutachten für Büros, Hallen, Industrie- und Gewerbeobjekte in Osnabrück und Umgebung.</p>
                </div>
            </section>
            ...
            <section className="section">
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 340px), 1fr))', gap: '3rem', alignItems: 'start' }}>
                        <div>
                            <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Gewerbeimmobilien professionell bewertet</h2>
                            <p style={{ fontSize: '1.05rem', color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '1.5rem' }}>
                                Gewerbe- und Industrieimmobilien stellen besondere Anforderungen an die Wertermittlung. Der Wert ergibt sich nicht nur aus Lage und Bausubstanz, sondern maßgeblich aus der wirtschaftlichen Nutzbarkeit, dem Ertragspotenzial und der Drittverwendungsfähigkeit.
                            </p>
                            <p style={{ fontSize: '1.05rem', color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '2rem' }}>
                                Unsere zertifizierten Sachverständigen bewerten alle gewerblichen Immobilientypen nach den anerkannten Verfahren der ImmoWertV.
                            </p>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
                                {['Bürogebäude', 'Lagerhallen & Logistik', 'Produktionsflächen', 'Verkaufsflächen & Retail', 'Industrie- & Technologieparks', 'Landwirtschaftliche Betriebe', 'Ärztezentren', 'Werkstätten'].map((item, i) => (
                                    <div key={i} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', padding: '0.75rem', backgroundColor: 'var(--bg-secondary)', borderRadius: '8px' }}>
