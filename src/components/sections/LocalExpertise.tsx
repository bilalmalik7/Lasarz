                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 400px), 1fr))', gap: '5rem', alignItems: 'center' }}>
                    ...
                    <div className="glass-card" style={{ padding: 0, overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}>
                        <img
                            ...
                            alt="Immobiliengutachter Osnabrück"
                    ...
                    <div>
                        ...
                        <h2 style={{ fontSize: '2.5rem', color: 'var(--accent-secondary)', marginTop: '1rem', marginBottom: '1.5rem', lineHeight: 1.2 }}>
                            Ihr Immobiliengutachter für Osnabrück und Umgebung
                        </h2>

                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: '1.1rem' }}>
                            <p>
                                Seit über 19 Jahren sind wir fest in der Region <strong>Osnabrück</strong> verwurzelt. Wir kennen nicht nur die statistischen Marktzahlen der Friedensstadt, sondern verstehen die mikro-lokalen Besonderheiten in Stadtteilen wie dem Westerberg, Hellern, der Wüste oder Kalkhügel.
                            </p>
                            <p>
                                Unsere Expertise erstreckt sich über das gesamte Osnabrücker Land bis hin nach Münster, Bielefeld und Flensburg. Als <strong>zerifizierte Immobiliengutachter</strong> bieten wir Ihnen die notwendige Sicherheit bei komplexen Entscheidungen.
                            </p>
